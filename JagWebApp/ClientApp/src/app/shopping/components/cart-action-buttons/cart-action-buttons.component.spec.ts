...
import { cartStubWithOneMenuItem, cartStubWithTwoMenuItems, cartSubWithDifferentItems } from 'shared/test/stubs/cart.stub';
...
describe('CartActionButtonsComponent', () => {
  ...
  function setUpInitialCart(initialCart, menuItemId) {
    ...
    spyOnProperty(authService, 'userId').and.returnValue(null);
  }
});
